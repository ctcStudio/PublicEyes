 ...
 */
class NMediaAdapter extends CursorAdapter implements RecyclerListener {

    private int mMediaType;
    private NImageLoader mImageLoader;
    private List<NMediaItem> mMediaListSelected = new ArrayList<>();
    private NMediaOptions mMediaOptions;
    private int mItemHeight = 0;
    private int mNumColumns = 0;
    private RelativeLayout.LayoutParams mImageViewLayoutParams;
    private List<PickerImageView> mPickerImageViewSelected = new ArrayList<>();
