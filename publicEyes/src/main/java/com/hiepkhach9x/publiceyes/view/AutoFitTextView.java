...
public class AutoFitTextView extends AppCompatTextView {
    ...
    /**
     * @return whether or not the text will be automatically resized to fit its
     * constraints.
     */
    ...
    /**
     * Sets the property of this field (singleLine, to automatically resize the
    ...
    /**
     * If true, the text will automatically be resized to fit its constraints;
    ...
    /**
     * @return the minimum size (in pixels) of the text size in this
     * AutofitTextView
     */
     ...
     * fit within it's bounds. Lower precision is more precise and takes more
     * time.
     *
